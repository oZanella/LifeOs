...
export function LoginView() {
  ...
  return (
    <main className="relative min-h-screen bg-background flex items-center justify-center px-3 py-4 sm:px-6 sm:py-6 overflow-hidden">
      ...
      <section className="relative w-full max-w-md md:max-w-4xl overflow-hidden rounded-2xl md:rounded-3xl border border-border/60 bg-card/90 shadow-2xl backdrop-blur-sm">
        <div className="grid md:grid-cols-2">
          <aside className="md:hidden px-4 py-5 bg-primary text-primary-foreground">
          ...
          <div className="p-4 sm:p-6 md:p-7">
            <div className="grid grid-cols-2 rounded-xl border border-border/50 bg-muted/30 p-1">
              <button
                ...
                className={`h-10 rounded-lg text-xs sm:text-sm font-semibold transition-colors cursor-pointer ${
                  !isRegister
            ...
            <div className="mt-5 min-h-75 sm:min-h-85">
